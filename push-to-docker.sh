docker tag validationsubscriber_subscriber quay.io/ripple/validators.ripple.com:$CIRCLE_SHA
docker tag validationsubscriber_subscriber quay.io/ripple/validators.ripple.com:$1
